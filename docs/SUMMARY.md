...
- [Adapters](adapters/index.md)
    ...
    - [CDAN](adapters/cdan.md)
    - [Classifier](adapters/classifier.md)
    - [DANN](adapters/dann.md)
    - [DomainConfusion](adapters/domain_confusion.md)
    - [Finetuner](adapters/finetuner.md)
    - [GAN](adapters/gan.md)
    - [GVB](adapters/gvb.md)
    - [MCD](adapters/mcd.md)
    - [RTN](adapters/rtn.md)
...
- [Containers](containers/index.md)
    ...
    - [MultipleContainers](containers/multiple_containers.md)
    - [Optimizers](containers/optimizers.md)
- [Datasets](datasets/index.md)
    - [BaseDownloadableDataset](datasets/base_downloadable_dataset.md)
